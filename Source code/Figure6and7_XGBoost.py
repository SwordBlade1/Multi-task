...
# Import model
loaded_model = pickle.load(open('/home/Multi-taskML/PredictiveResults/XGBoost/20SNAP/XGBoost_reg.dat', 'rb'))
print('Loaded model from: XGBoost_reg.dat')
reg = loaded_model

# Read different alloy system respectively, nine kinds in total
...
# Import model
loaded_model = pickle.load(open('/home/Multi-taskML/PredictiveResults/XGBoost/3PI/XGBoost_reg.dat', 'rb'))
print('Loaded model from: XGBoost_reg.dat')
reg = loaded_model
